...
def extract_event_codes(nidq_file):
    ...
    # Find the event codes where the change occurred
...
def align_data_streams(sync_files, data_stream_info, reference_stream, ks_ver='3'):
    ...
    for ix, this_dir in enumerate(sync_dirs):
        ...
        if 'imec' in data_stream_info[ix]:
            ...
            spike_dir = Path(str(this_dir) + '/' + 'kilosort4')
